...
import (
	...
	"github.com/KyleKichulYun/Lightweight-AI-Model-Serving-Router/operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0501f551.kyle.io",
	...
	if err := (&controller.ModelAutoscalerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "ModelAutoscaler")
		os.Exit(1)
	}
